...
object FragmentUtil {
    ...
    fun add(context: Context, fragment: Fragment) {
        ...
        tran.setCustomAnimations(com.caldremch.common.R.anim.cm_fragemnt_in, com.caldremch.common.R.anim.cm_fragemnt_out)
    ...
    fun remove(context: Context, fragment: Fragment) {
        ...
        manager.setCustomAnimations(com.caldremch.common.R.anim.cm_fragemnt_in, com.caldremch.common.R.anim.cm_fragemnt_out)
